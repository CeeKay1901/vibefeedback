...
(function () {
  ...
  style.textContent = [
    ...
    ".__vfl_modal-bg { position:fixed; inset:0; background:rgba(38,38,38,.35); backdrop-filter:blur(4px); z-index:2147483647; display:grid; place-items:center; padding:20px; }",
    ".__vfl_modal { background:#fff; border:1px solid #e3e1d6; border-radius:18px; width:100%; max-width:520px; padding:20px; box-shadow:0 20px 48px rgba(38,38,38,.2); max-height:calc(100dvh - 40px); overflow-y:auto; }",
    ".__vfl_modal h3 { margin:0 0 12px; font-size:16px; color:#262626; display:flex; align-items:center; gap:8px; }",
    ...
    ".__vfl_modal .__vfl_field { margin-bottom:10px; }",
    ".__vfl_modal label { display:block; font-size:11.5px; color:#7b7a71; margin-bottom:5px; text-transform:uppercase; letter-spacing:.6px; font-weight:600; }",
    ".__vfl_modal input, .__vfl_modal textarea { width:100%; background:#fff; border:1px solid #e3e1d6; color:#262626; padding:9px 11px; border-radius:8px; font:14px inherit; outline:none; }",
    ".__vfl_modal input:focus, .__vfl_modal textarea:focus { border-color:#262626; box-shadow:0 0 0 3px rgba(255,224,94,.35); }",
    ".__vfl_modal textarea { min-height:60px; resize:vertical; line-height:1.5; }",
