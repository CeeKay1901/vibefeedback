// Regeneriert layer.min.js und die Bookmarklet-Zeile in index.html aus layer.js
const fs = require("fs");
...
(async () => {
  ...
  const html = fs.readFileSync(path.join(VF, "index.html"), "utf8");
  ...
  fs.writeFileSync(path.join(VF, "index.html"), lines.join("\n"));
  console.log("index.html bookmarklet line", idx + 1, "updated,", lines[idx].length, "chars");
})();
